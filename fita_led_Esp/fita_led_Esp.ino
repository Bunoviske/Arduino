...
typedef struct {
  ...
  int trecho[5]; //armazenar os tempos em segundos
  int tempo[5];
...
int NUMPIXELS = tamanho * 10; //está sendo considerado uma fita que tem 30 leds/m e que é alimentada por 12V (controle de 3 leds por vez)

Adafruit_NeoPixel fita = Adafruit_NeoPixel(NUMPIXELS, PIN, NEO_GRB + NEO_KHZ400);
