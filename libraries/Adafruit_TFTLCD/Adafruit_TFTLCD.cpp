...
static const uint16_t ILI932x_regValues[] PROGMEM = {
  ...
  ILI932X_DRIV_OUT_CTRL    , 0x0100, //0x0100
  ...
  ILI932X_GATE_SCAN_CTRL1  , 0x2700, // Driver Output Control (R60h) 	#ifdef DRIVER_BUG 0x2700 #else 0xA700
...
void Adafruit_TFTLCD::sleep(){
	//writeRegister16(ILI932X_POW_CTRL1, 0x0002);
    //writeRegister16(TFTLCD_DELAY, 50);
    //reset();
	writeRegister16(ILI932X_DISP_CTRL1, 0x0000);
	delay(200);
    setRotation(rotation);
    setAddrWindow(0, 0, TFTWIDTH-1, TFTHEIGHT-1);
}

void Adafruit_TFTLCD::wake(){
	//writeRegister16(ILI932X_START_OSC, 0x0001);
	//writeRegister16(ILI932X_POW_CTRL1, 0x0190);
	//writeRegister16(TFTLCD_DELAY, 50);
