...
void initInicializaComeco() {
  ...
  tft.print("Serie ");
  tft.println(itoa(gb::serieAtualCont + 1, NULL,10));
  tft.setCursor(45, 80);
    ...
    if (p.y > 125 & p.y < 175) {
      ...
      if (p.x > 237 & p.x < 299)
      {
        ...
        if (string_lida.length() > 0 && numero_pergunta == 1 && string_lida.toInt() > 0) {
          ...
          numero_pergunta = 2;
          gb::serieAtual.qtdSeries = string_lida.toInt();
          string_lida = "";
          x_inicial = 250;
          ...
          tft.println("segs");
          numero_pergunta = 3;
          gb::serieAtual.repeticoes = string_lida.toInt();
          string_lida = "";
          x_inicial = 220;
        }
          ...
          tft.println("segs");
          numero_pergunta = 5;
          gb::serieAtual.TimeIda = string_lida.toInt();
          x_inicial = 230;
          string_lida = "";
        }
        else if (string_lida.length() > 0 && numero_pergunta > 4 && string_lida.toInt() > 0) {
          ...
          gb::serieAtual.TimeVolta = string_lida.toInt();
          string_lida = "";
          x_inicial = 250;
          numero_pergunta = 1;
          gb::firstTime = 1;
