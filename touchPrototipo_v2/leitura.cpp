...
void initTouchPersonalizado() {
  ...
  tft.drawRoundRect(5, 15, 50, 50, 5, WHITE);
...
void updateRepeticao(uint8_t numero) {
  ...
  if (numero == gb::serieAtual.repeticoes) {
    tft.setTextSize(5);
...
void initInicializaComeco() {
  ...
  tft.print("Serie ");
  tft.println(gb::serieAtualCont + 1);
  tft.setCursor(45, 80);
...
void init_info() {
  ...
  switch (gb::modo) {
    ...
    case MODO_HIPERTROFIA_INICIANTE:
      ...
      gb::serieAtual.qtdSeries = 1;
      gb::serieAtual.repeticoes = 10;
      gb::serieAtual.intervalo = 60;
      gb::serieAtual.TimeIda = 2;
      gb::serieAtual.TimeVolta = 3;
      ...
      tft.setCursor(15, 60);
      tft.print("Series: ");
      tft.println(gb::serieAtual.qtdSeries);
      tft.setCursor(15, 95);
      tft.print("Repeticoes: ");
      tft.println(gb::serieAtual.repeticoes);
      tft.setCursor(15, 130);
      tft.print("Descanso: ");
      tft.println(gb::serieAtual.intervalo);
      tft.setCursor(15, 165);
      tft.print("Cadencia: ");
      tft.print(gb::serieAtual.TimeIda);
      tft.print(":");
      tft.println(gb::serieAtual.TimeVolta);
      break;
    ...
    case MODO_HIPERTROFIA_AVANCADO:
      ...
      gb::serieAtual.qtdSeries = 1;
      gb::serieAtual.repeticoes = 10;
      gb::serieAtual.intervalo = 45;
      gb::serieAtual.TimeIda = 2;
      gb::serieAtual.TimeVolta = 4;
    ...
    case MODO_RESISTENCIA:
      ...
      gb::serieAtual.qtdSeries = 3;
      gb::serieAtual.repeticoes = 15;
      gb::serieAtual.intervalo = 60;
      gb::serieAtual.TimeIda = 2;
...
uint8_t getUserInfoTouchPersonalizado() {
  ...
  if (p.z > MINPRESSURE && p.z < MAXPRESSURE)
  {
    ...
    if (p.y > 125 & p.y < 175) {
      ...
      if (p.x > 237 & p.x < 299)
      {
        ...
        if (string_lida.length() > 0 && numero_pergunta == 1 && string_lida.toInt() > 0) {
          ...
          numero_pergunta = 2;
          gb::serieAtual.qtdSeries = (uint8_t)string_lida.toInt();
          string_lida = "";
          x_inicial = 290;
          ...
          tft.println("s");
          numero_pergunta = 3;
          gb::serieAtual.repeticoes = (uint8_t)string_lida.toInt();
          string_lida = "";
          x_inicial = 250;
        }
          ...
          tft.setCursor(295, 30);
          tft.println("s");
          numero_pergunta = 4;
          gb::serieAtual.intervalo = string_lida.toInt();
          string_lida = "";
          x_inicial = 270;
        }
          ...
          tft.println("s");
          numero_pergunta = 5;
          gb::serieAtual.TimeIda = (uint8_t)string_lida.toInt();
          x_inicial = 270;
          string_lida = "";
        }
        else if (string_lida.length() > 0 && numero_pergunta > 4 && string_lida.toInt() > 0) {
          ...
          gb::serieAtual.TimeVolta = (uint8_t)string_lida.toInt();
          string_lida = "";
          x_inicial = 250;
          numero_pergunta = 1;
    ...
    if (p.y > 0 & p.y < 20) {
      if (p.x > 0 & p.x < 50) {
        tft.fillRoundRect(4, 14, 48, 48, 5, RED);
        tft.setCursor(25, 30);
        tft.setTextSize(2.2);
        tft.println("<");
        delay(500);
        tft.fillRoundRect(5, 15, 50, 50, 5, BLACK);
        delay(100);
        tft.setCursor(25, 30);
        tft.setTextSize(2.2);
        tft.println("<");
